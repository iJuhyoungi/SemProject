...
> **초기 학습 단계의 스냅샷 (1/5) — UART 와 클럭 부스팅 시점**
>
...
>
> **이 시점에 새로 된 것** — 132MHz 클럭 부스팅과 UART TX. XIP 실행 중 클럭을 바꾸면 flash 통신이 끊겨 HardFault 가 나므로, **클럭 제어 함수만 ITCM 으로 재배치**해 해결했습니다 (`.ramfunc`, [TARGET_RELOCATION.md](docs/TARGET_RELOCATION.md))
>
