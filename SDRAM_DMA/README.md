...
> **초기 학습 단계의 스냅샷 (5/5) — eDMA 와 캐시 일관성 시점**
>
...
>
> **이 시점에 새로 된 것** — eDMA memory-to-memory 전송 (`src/dma.c`). CPU 가 쓴 데이터를 DMA 가 읽을 때 생기는 **캐시 일관성 문제**를 clean/invalidate 로 다뤘습니다 ([Phase1_5_DMA_Dynamic_Coherency.md](docs/Phase1_5_DMA_Dynamic_Coherency.md))
>
