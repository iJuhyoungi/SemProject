...
>
> **이 시점에 새로 된 것** — I-Cache / D-Cache 활성화와 MPU 설정 (`src/cache.c`, `src/mpu.c`). 캐시 ON/OFF 를 바꿔가며 실제 성능 차이를 측정했습니다 ([CACHE_BENCHMARK.md](docs/CACHE_BENCHMARK.md))
>
